...
class Encoder(object):
    ...
    def decode_batch(self, bboxes_in, scores_in, nms_threshold=0.45, max_output=500):
    ...
    # def decode_single(self, bboxes_in, scores_in, nms_threshold, max_output, max_num=500):
    #     bboxes_out = []
    #     scores_out = []
    #     labels_out = []
    ...
    #                                          torch.tensor(labels_out, dtype=torch.long).to(self.device), \
